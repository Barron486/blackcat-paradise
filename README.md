...
- **聊天與通知**：世界聊天、線上人數及名單、傳說／遺物裝備掉落跑馬燈。GM 可管理 AI 聊天內容、角色、回覆玩家與生成頻率，支援本機 Ollama、Codex CLI 或伺服器模型 API，保留 AI 身分標示。
...
本版 **153 項測試通過**，涵蓋帳號隔離、CSRF、GM 權限、存檔衝突、升級保存、藍鑽與卡片、交易重試及原子性、CLI、AI 聊天、世界設定與掉寶廣播。測試使用隔離資料庫。
